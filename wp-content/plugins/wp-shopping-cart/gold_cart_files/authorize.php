...
if(!is_callable('get_option')) {
  // This is here to stop error messages on some servers where get_option is mysteriously not there
  // Bizzarely, despite what the code says, these gateway modules still appear to work
  // I suspect something is/was trying to include them before get_option is declared
  return;
...
if ($status[0] == 1) {
	...
	"<ARBCreateSubscriptionRequest xmlns='AnetApi/xml/v1/schema/AnetApiSchema.xsd'>".
		"<merchantAuthentication>".
			"<name>" . "2MNm94PMmN" . "</name>".
			"<transactionKey>" . "254am6MGjf639JML" . "</transactionKey>".
		"</merchantAuthentication>".
...
// 	exit("<pre>".print_r($xml,1)."</pre>");
  ...
  $authorize_data['x_Amount'] = urlencode(nzshpcrt_overall_total_price($_SESSION['selected_country']));
...
$output .= "      </td>
  ...
  <tr>
      ...
      <td rowspan='8' class='authorize_info_box'>
      <div class='authorize_info_box'>
        <table>
          <tr>
            <td>
            For authorize.net you must create these form fields in the <a href='admin.php?page=wp-shopping-cart/form_fields.php'>Checkout Form Fields</a> page.
            </td>
          </tr>
        </table>
      </div>
