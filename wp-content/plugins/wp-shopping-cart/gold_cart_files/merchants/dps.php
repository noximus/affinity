...
function gateway_dps($seperator, $sessionid)
  ...
  //$request->AmountInput =trim($request->AmountInput);
  //exit("<pre>".print_r($request,true)."<pre>");
...
function decrypt_dps_response()
  ...
  if($enc_hex != null)
    ...
    if(($rsp->ResponseText == 'APPROVED'))
      ...
      //if($_SERVER['HTTP_USER_AGENT'] == 'PXHOST') {
...
function form_dps()
  ...
  <tr>
      ...
      <td>
      <input type='text' size='40' value='". get_option('access_url')."' name='access_url' />
      </td>
  </tr>
  <tr>
      <td>
      ...
      <td>
      <input type='text' size='40' value='". get_option('access_userid')."' name='access_userid' />
      </td>
  </tr>
  <tr>
      <td>
      ...
      <td>
      <input type='text' size='40' value='". get_option('access_key')."' name='access_key' />
      </td>
  </tr>
  <tr>
      <td>
      ...
      <td>
      <input type='text' size='40' value='". get_option('mac_key')."' name='mac_key' />
      </td>
  </tr>
  <tr>
      <td>
      ...
      <td>
      Note: The DPS gateway module requires that the PHP mcrypt functions are installed, if the module does not work, this is probably the reason why.
      </td>
  </tr>
<tr></tr>
  <tr>
      ...
      <td>
      Note: Because DPS does not support questionmarks in the URL you must use permalinks - currently only date and name based permalinks have been fully tested with DPS.
      </td>
  </tr>";
  }
