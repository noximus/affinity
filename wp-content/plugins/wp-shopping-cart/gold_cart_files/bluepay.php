...
if(get_option('payment_gateway') == 'bluepay')
  {
...
//     }
  ...
  $x_Amount= urlencode(nzshpcrt_overall_total_price($_SESSION['selected_country']));
  //exit($x_Amount);
 ...
 // exit("<pre>".print_r($return,true)."</pre>");
  ...
  switch ($details) 
    ...
    $_SESSION['nzshpcrt_checkouterr'] = $return[3];
  ...
  <tr>
      ...
      <div class='bluepay_info_box'>
        <table>
          <tr>
            <td>
            For bluepay.net you must create these form fields in the <a href='admin.php?page=wp-shopping-cart/form_fields.php'>Checkout Form Fields</a> page.
            </td>
          </tr>
        </table>
      </div>
